...
include_graphics(
  file.path(main_dir,"plots/fo-recall/plt_fo_prop.svg")
)
```
...
- The odds of stating the extreme value given they are seeing the high-risk door is `r OR[1]` times that of seeing the low-risk door and getting it wrong.
...
- The odds of stating the extreme value given they are seeing the high-risk door is `r OR[2]` times that of seeing the low-risk door and getting it wrong.
...
- The odds of stating the extreme value given they are seeing the high-risk door is `r OR[3]` times that of seeing the low-risk door and getting it wrong.
...
- Post-hoc analysis on each $\chi^2$ test was conducted by evaluating the standardized residuals from the chi-square analysis because it seemed the most intuitive approach. However, another approach would be to conduct pairwise Pearson Chi-squared or Fisher Exact tests across the three conditions.
